...
let state = { macro:{}, sectors:{}, companies:{}, portfolio:{positions:[],cash:"",capPosition:"10",capSector:"25"},
              events:[], sources:[], log:[] };
let route = { workspace:"investing", view:"dash", id:null, tab:"reading", ticker:null, companyTab:"overview", analysisMode:"full", analysisRan:false, analysisRunning:false, analysisRanAt:null, analysisError:null, tradeChartMode:"price", tradeRange:"1M", tradeTicker:"KSE100" };
let typing = false;
